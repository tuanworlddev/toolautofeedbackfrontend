            ...
            <div className="flex items-center justify-between bg-white rounded-md p-3 mb-3">
                <div>
                    <div className="flex items-center justify-start gap-3">
                        <div className="text-blue-800 text-2xl font-bold">Shop: {shop.name} </div>
                ...
                <div className="">
                    {shop.activate ? (
                        <div className="flex flex-col gap-2">
                            ...
                            <button onClick={() => onToggleActivate(shop.id)} className="text-red-500 bg-red-50 cursor-pointer border border-red-400 rounded-md">Unactivate</button>
                        </div>
                    ) : (
            ...
            {shop.activate ? (
                <div className="flex items-center justify-between gap-3 mb-3">
                    <div className="w-full md:w-1/2 bg-white rounded-md p-3">
                        <div className="text-xl font-bold text-blue-800 mb-2">Info count unanswered</div>
                        <div>
